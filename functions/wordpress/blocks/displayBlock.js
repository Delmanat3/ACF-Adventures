...
export default function displayBlock(block, index) {
  ...
  switch (name) {
    ...
    case 'gravityforms/form': {
      ...
      // ADDED
    case 'acf/card': {
      const Dood = dynamic(() => import('@/components/organisms/AnnieHathaways'))
      return <Dood {...attributes} key={index} />
    }
    case 'acf/peaty': {
      const Peat = dynamic(() => import('@/components/blocks/repeat/HathRepeat'))
      return <Peat {...attributes} key={index} />
    }
